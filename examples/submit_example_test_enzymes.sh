...
output_dir="../outputs/example_test_enzymes_outputs"
if [ ! -d $output_dir ]
then
    mkdir -p $output_dir
fi
...
tied_positions="1:8, 2:9, 3:10, 4:11" #two list must match in length; residue 1 in chain A and C will be sampled togther;
